...
date: "2026-02-08"
categories: [baseball, mlb, kaggle, dataset, bat-tracking]
image: "https://storage.googleapis.com/kaggle-datasets-images/6262899/10269697/c7b52e8cd9eff3b2d8cb9c6ea01bde29/dataset-cover.png?t=2026-02-08-23-37-16"
---
...
Baseball Savant Leaderboard: [Bat Tracking Stats](https://baseballsavant.mlb.com/leaderboard/bat-tracking)
...
```python
# Distribution of attack angles
plt.hist(df['attack_angle'], bins=30, edgecolor='black')
plt.xlabel('Attack Angle (degrees)')
plt.ylabel('Count')
plt.title('Attack Angle Distribution (2024-2025)')
plt.axvline(df['attack_angle'].mean(), color='red', linestyle='--', label='Mean')
plt.legend()
plt.show()
```
...
A full analysis notebook demonstrating the use of this dataset:

[MLB Bat Tracking Analysis (2024-2025)](https://www.kaggle.com/code/yasunorim/bat-tracking-japanese-mlb-batters-2024-2025)
